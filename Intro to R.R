...
# working directory
setwd("C:/Users/Juan/Documents/1. ENREM/6 sem/Data science for environmental scientists/Intro_to_R")

# load data
edidiv <- read.csv("C:/Users/Juan/Documents/1. ENREM/6 sem/Data science for environmental scientists/Intro_to_R/CC-RBasics-master/edidiv.csv")
...
#### Edit one column
edidiv$taxonGroup <- as.factor(edidiv$taxonGroup)     # Changing character to Factor
